...
ward_data = [
    ...
    {
        "No": 5, "区": "文京区", 
        "教育特色": "「教育の府」。御三家（誠之・昭和・千駄木・窪町）を筆頭に公立小のレベルが極めて高く、低学年から中学受験塾へ通う比率が都内最高。国立大附属校も多く教育熱心な層が集中。",
        "独自支援": "「文京区版ネウボラ」による伴走支援。困窮世帯への「こども宅食」発祥の地でもあり、教育格差を埋める支援が充実。教育相談センターのカウンセリング体制は非常に質が高い。"
    },
    {
        "No": 6, "区": "台東区", 
        "教育特色": "「台東区版GIGAスクール」により、個別最適化された学びを提供。博物館や美術館（上野）と連携した「本物の文化体験教育」が特色。伝統工芸を学ぶ授業も多い。",
        "独自支援": "「小学校・中学校入学お祝い金」を支給。さらに「子育て世帯家賃助成」があり、区外から転入するファミリー世帯への経済的ハードルを低くする独自の工夫がある。"
    },
    {
        "No": 7, "区": "墨田区", 
    ...
    {
        "No": 8, "区": "江東区", 
        "教育特色": "湾岸エリアを中心に最新教育設備を導入。理数系教育に力を入れる「理数インター」的アプローチや、土曜塾の開催、不登校児童への「ステップアップ教室」が充実。",
        "独自支援": "待機児童ゼロを達成。第2子以降の保育料無償化に加え、私立幼稚園等への入園料助成金を増額。区独自のアプリ「マイ保育園」で予防接種管理から相談まで一元管理。"
    },
    {
        "No": 9, "区": "品川区", 
        "教育特色": "「小中一貫教育」の先駆者。4-3-2制のカリキュラムを導入。英語教育「市民科」という独自の教科があり、論理的思考力とプレゼン力を育てる教育が定評。",
        "独自支援": "「しながわネウボラネットワーク」により、全ての妊産婦に1万円相当の育児用品を配布。独自の「シルバー人材センター連携預かり」など、地域資源を活かした預かり機能が強い。"
    },
    {
        "No": 10, "区": "目黒区", 
        "教育特色": "「目黒区版教育の情報化」。全校に電子黒板とタブレットを完備し、思考力の可視化を重視。自由が丘や駒場エリアなど教育意識の高い地域が多く、学校公開も活発。",
        "独自支援": "子育て支援センター「ほっぺ」が非常に充実。一時預かりの予約がオンラインで完備されており、利便性が高い。産後ケアの利用料助成が手厚く、産後の孤立を防ぐ取り組みが先行。"
    },
    {
        "No": 11, "区": "大田区", 
        "教育特色": "理数教育の重点化。町工場と連携した科学体験授業や、JAL・ANAと連携したキャリア教育を実施。全校で「放課後ひろば」を実施し、共働き世帯の居場所を確保。",
        "独自支援": "子育てひろば「ぴよぴよ」を各地域に配置。第3子以降の出産祝金や、独自の家賃助成（条件あり）など、子育て世帯が定住しやすい経済的支援が継続されている。"
    },
    {
        "No": 12, "区": "世田谷区", 
        "教育特色": "「せたがやの教育」。公立校の自主性を重んじ、独自の「日本語教育」や食育に定評。学校運営に地域が関わる「コミュニティ・スクール」の実施率が高く、地域全体で子供を守る風土。",
        "独自支援": "「せたがや子育て利用券（1万円分）」を全妊婦に配布。児童館の数が23区随一で、放課後や休日の子供の遊び場に困らない。産後ケアセンターの発祥地でありケア体制も強固。"
    },
    {
        "No": 13, "区": "渋谷区", 
        "教育特色": "「シブヤ・スマート教育」。1人1台のセルラーモデルタブレットを全国に先駆けて配布。民間企業（サイバーエージェント等）と提携した高度なプログラミング教育を実施。",
        "独自支援": "「ハッピーマザー出産助成金」として一律10万円を上乗せ支給。育児用品レンタル代の補助や、最新のITを駆使した保育園入所シミュレーションなど、スマートな支援が特徴。"
    },
    {
        "No": 14, "区": "中野区", 
        "教育特色": "「中野型ICT教育」。プログラミング教育に加え、情報モラル教育に注力。公立小中学校の再編に合わせ、全校で最新のラーニングコモンズ（学習共有スペース）を設置。",
        "独自支援": "「子育て応援ギフト」として妊娠・出産時に各5万円を支給。ブックスタート（絵本配布）に加え、セカンドブック（2歳児への絵本配布）も実施し、読書習慣の育成を支援。"
    },
    {
        "No": 15, "区": "杉並区", 
        "教育特色": "「すぎなみ教育プラン」。公立校の質向上を掲げ、習熟度別学習や少人数授業を徹底。保護者の学校評価を公開し、開かれた学校づくりを推進。中学受験率も安定して高い。",
        "独自支援": "「すぎなみ子育て応援券（最大4万円分）」が有名。一時預かりや家事支援、ベビーマッサージ等に利用可能。区民ボランティアによる預かり「ひととき保育」も非常に活発。"
    },
    {
        "No": 16, "区": "豊島区", 
        "教育特色": "「消滅可能性都市」からの脱却を掲げ、教育に最優先投資。最新の校舎改築、放課後の「スキップ」での学習支援、SDGs教育を軸としたグローバル人材育成を推進。",
        "独自支援": "「待機児童ゼロ」を長年継続。多子世帯への保育料軽減が手厚く、所得制限なしで第2子以降無償化も実施。区独自の「子育てマイページ」で行政サービスを最適化。"
    },
    {
        "No": 17, "区": "北区", 
        "教育特色": "「子育てするなら北区が一番」を掲げる。公立校の学力向上に向けた独自の「学習診断テスト」を実施し、分析に基づいた補習を展開。部活動の地域連携も進んでいる。",
        "独自支援": "「安心ママパパ応援団」による産前産後の家事育児支援（1時間500円と安価）。第3子以降の義務教育期間中の給食費無償化を他区に先駆けて実施した実績あり。"
    },
    {
        "No": 18, "区": "荒川区", 
        "教育特色": "「読書のまち」。学校図書館の充実度は全国屈指で、専任の司書配置を徹底。俳句授業や、ICTを活用した「対話的な学び」により、全国学力調査の成績が近年急上昇中。",
        "独自支援": "「あらかわ家族の日」に合わせたイベントや優待が豊富。多子世帯への「おむつ専用ごみ袋」無料配布や、独自の塾代助成制度（中学生対象）など、家計に直結する支援が多い。"
    },
    {
        "No": 19, "区": "板橋区", 
        "教育特色": "「いたばし学び支援プラン」。絵本教育を軸とし、イタリアのレッジョ・エミリア教育を取り入れた先進的な幼児教育を推進。公立校全校でのコミュニティ・スクール化が完了。",
        "独自支援": "「すくすくカード」で有料の子育て支援サービスを利用可能。第2子以降の保育料完全無償化。区立公園内での遊び場づくり「プレーパーク」活動が非常に盛ん。"
    },
    {
        "No": 20, "区": "練馬区", 
        "教育特色": "公立小中学校数が23区で最も多く、地域の目が子供に行き届きやすい。ICT活用と併せ、伝統的な読み書き計算を重視する「練馬区版教育」で学力水準が安定している。",
        "独自支援": "「第3子誕生祝金（10万円）」を支給。保育所待機児童ゼロを維持しつつ、幼稚園での預かり保育「練馬こども園」認定を拡大。私立幼稚園派の世帯にも非常に優しい。"
    },
    {
        "No": 21, "区": "足立区", 
        "教育特色": "「学力定着の徹底」。放課後学習だけでなく、朝の学習支援や、夏休み中の「足立っ子学習塾」など、学校外教育の補完が凄まじい。近年、学力調査の伸び率が都内トップレベル。",
        "独自支援": "「あだち家庭教育学級」で親の学びを支援。経済的支援として、私立高校等への授業料補助が手厚い。また、子供の貧困対策としての食支援や居場所づくりが23区で最も先進的。"
    },
    {
        "No": 22, "区": "葛飾区", 
        "教育特色": "23区で初めて「学校給食費の完全無償化」を決定・実施。全校で1人1台端末を活用した「葛飾区ICT教育推進計画」を遂行。校舎の耐震・改築率100%を達成済みで安全面も強い。",
        "独自支援": "「マタニティパス（5,500円分の交通ICカード）」配布。第2子以降の保育料完全無償化（所得制限なし）。3人乗り自転車の購入費補助など、移動支援が手厚いのも特徴。"
    },
    {
        "No": 23, "区": "江戸川区", 
        "教育特色": "「共育」。独自の「よさこい」や「スポーツ教育」を通じた人格形成。公立校の学童機能「すくすくスクール」は夜間まで対応可能で、働く親からの支持が絶大。",
        "独自支援": "「乳児養育手当（月13,000円）」を1歳まで支給。これは保育園に入れない家庭への実質的な手当。親族間での「孫育て」支援など、3世代同居を推進する独自施策も多い。"
    }
]
