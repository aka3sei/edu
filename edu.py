...
ward_info_map = {
    "千代田区": {"特色": "ICT教育先進区。中高一貫の九段中等教育学校が人気。", "支援": "次世代育成手当月5000円支給。"},
    "中央区": {"特色": "晴海エリア校舎新設。放課後遊び場「プレディ」全校実施。", "支援": "第2子以降保育料完全無償化。"},
    "港区": {"特色": "国際理解教育。独自の小中一貫校が充実。慶應・広尾・麻布が揃う。", "支援": "出産費用助成最大60万円。"},
    "新宿区": {"特色": "日本語指導フォロー手厚い。海城・早稲田など名門男子校の集積地。", "支援": "子どもショートステイ制度。"},
    "文京区": {"特色": "教育の府。東大・桜蔭・筑附を擁し、公立小のレベルも最高峰。", "支援": "文京区版ネウボラ伴走支援。"},
    "台東区": {"特色": "上野の文化資源を活用した体験教育が豊富。", "支援": "入学お祝い金支給制度。"},
    "墨田区": {"特色": "ものづくり教育と最新校舎への改築推進。", "支援": "すみだ型ネウボラ支援。"},
    "江東区": {"特色": "湾岸エリアの最新設備。芝浦工大附属など理数教育に強み。", "支援": "待機児童ゼロ達成。"},
    "品川区": {"特色": "小中一貫教育の先駆。独自教科「市民科」。", "支援": "育児用品配布ネウボラ。"},
    "目黒区": {"特色": "思考力の可視化教育。東工大キャンパスがある文教地区。", "支援": "子育て支援センター「ほっぺ」。"},
    "大田区": {"特色": "町工場連携の理数教育。放課後ひろば実施。", "支援": "子育てひろば「ぴよぴよ」。"},
    "世田谷区": {"特色": "駒東・鴎友・三田国際等、難関校が多い住宅街。児童館数最多。", "支援": "せたがや子育て利用券。"},
    "渋谷区": {"特色": "渋渋を筆頭にIT・プログラミング教育に強み。", "支援": "ハッピーマザー助成金。"},
    "中野区": {"特色": "情報モラル教育。ラーニングコモンズ整備。", "支援": "子育て応援ギフト計10万円。"},
    "杉並区": {"特色": "少人数授業徹底。教育意識が非常に高い世帯が多い。", "支援": "すぎなみ子育て応援券。"},
    "豊島区": {"特色": "豊島岡・本郷がある。学習支援スキップが充実。", "支援": "第2子以降保育料無償化。"},
    "北区": {"特色": "学習診断テスト導入。給食費完全無償化。", "支援": "安心ママパパ応援団。"},
    "荒川区": {"特色": "読書のまち。開成中があり、学力調査成績も急上昇中。", "支援": "塾代助成制度（中学生）。"},
    "板橋区": {"特色": "先進的幼児教育。コミュニティスクール活発。", "支援": "すくすくカード。"},
    "練馬区": {"特色": "武蔵中を擁する。公立校数最多で教育環境が安定。", "支援": "第3子誕生祝金10万円。"},
    "足立区": {"特色": "学力定着の徹底。朝の学習支援など補完教育が充実。", "支援": "貧困対策・食支援の先進。"},
    "葛飾区": {"特色": "給食費完全無償化。校舎改築率100%。", "支援": "マタニティパス配布。"},
    "江戸川区": {"特色": "すくすくスクール。乳児養育手当が独自。", "支援": "乳児養育手当月1.3万円。"},
    "武蔵野市": {"特色": "吉祥女子があり、地域見守り体制が非常に強固。", "支援": "文教都市としての独自の教育相談。"},
    "国分寺市": {"特色": "早稲田実業がある。理数・フィールド学習重視。", "支援": "子育てアプリ・産後サポート。"},
    "国立市": {"特色": "一橋大を擁する学園都市。教育環境維持への意識が高い。", "支援": "産前産後ケアの充実。"},
    "府中市": {"特色": "東京外大等の教育機関。スポーツ教育も盛ん。", "支援": "子育て家計への安定した支援。"}
}
